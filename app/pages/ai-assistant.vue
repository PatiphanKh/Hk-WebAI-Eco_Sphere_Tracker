  ...
  messages.value = [
    {
      id: Date.now(),
      sender: 'ai',
      text: `สวัสดีครับ🌲 ยินดีต้อนรับสู่ Eco AI Assistant ครับ! ผมพร้อมช่วยคุณวิเคราะห์ข้อมูลคาร์บอนฟุตพริ้นท์สะสม รวมถึงแนะนำแนวทางรักษ์โลกที่เหมาะกับไลฟ์สไตล์ของคุณ วันนี้อยากให้ผมช่วยในเรื่องไหนเป็นพิเศษไหมครับ?`
    }
  ]
}
